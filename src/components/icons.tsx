// Icon set for the Kadr interface.
//
...
//
// Generated from lucide-static 1.37.0; edit the map in scripts, not the paths by hand.
...
const GLYPHS: Record<string, ReactElement> = {
  ...
  transition: (
    <><circle cx="15" cy="9" r="7" /><circle cx="9" cy="15" r="7" /></>
  ),
  trash: (
